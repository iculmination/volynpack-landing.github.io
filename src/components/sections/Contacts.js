      ...
      >
        ...
        <div className="text-white z-10 relative p-8 md:p-32 pt-16 md:pt-48 text-center">
          ...
          <p className="text-lg mb-2">
            <a href="mailto:example@gmail.com" className="text-white hover:underline">Електронна пошта: example@gmail.com</a>
          </p>
          <p className="text-lg mb-2">
            <a href="tel:1234567890" className="text-white hover:underline">Телефон: +1-234-5677-890</a>
          </p>
          <p className="text-lg mb-2">Адреса складу: вул. Приклад, м. Приклад</p>
          <div className="flex justify-center gap-4 mt-4">
            <img src={insta} className="w-7 h-7 cursor-pointer" alt="Instagram" />
